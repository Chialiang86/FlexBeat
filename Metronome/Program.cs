...
namespace Metronome
{
    ...
    class mainwindow : Form
    {
        ...
        private void setting_com_SelectedItemChanged(object sender, EventArgs e)
        {
            ...
            else if(this.setting_com.Text == this.setting_text[3])// background change
            {
                FontDialog f = new FontDialog();
                f.ShowDialog();
                this.speed_show.Font = f.Font;
                this.sig_show.Font = f.Font;
                this.style_show.Font = f.Font;
                this.drumset_show.Font = f.Font;
                this.message_show.Font = f.Font;
                this.play_btn.Font = f.Font;
                this.test_btn.Font = f.Font;
                this.rst_btn.Font = f.Font;
                this.clear_btn.Font = f.Font;
                this.beat_speed_nud.Font = f.Font;
                this.time_sig_com.Font = f.Font;
                this.drum_set_com.Font = f.Font;
                this.setting_com.Font = f.Font;
                this.style_com.Font = f.Font;
                this.test_com.Font = f.Font;
                this.edit_btn.Font = f.Font;
            }
